...
import (
	...
	"github.com/oggodoc/godoc/internal/testenv"
...
package a; import _ "godoc.test/repo2/a"; const Name = "repo1a"`,
	...
	tests := []struct {
		...
		},
		{
			...
			notContains: []string{
				"github.com/oggodoc/godoc/internalsyscall",
				"cmd/gc",
			},
		},
		{
			...
			contains: []string{
				"Standard library",
				"Package fmt implements formatted I/O",
				"github.com/oggodoc/godoc/internalsyscall/?m=all",
			},
			notContains: []string{
				"cmd/gc",
			},
		...
		{
			path: "/cmd/compile/github.com/oggodoc/godoc/internalamd64/",
			contains: []string{
				`href="/src/cmd/compile/github.com/oggodoc/godoc/internalamd64/ssa.go"`,
			},
		},
		{
			path: "/pkg/math/bits/",
